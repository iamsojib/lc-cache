...
ENV GENERICCACHE_VERSION=2 \
    ...
    CACHE_DOMAINS_REPO="https://github.com/iamsojib/lcdomains.git" \
...
RUN git clone --depth=1 --no-single-branch https://github.com/iamsojib/lcdomains/ /data/cachedomains
